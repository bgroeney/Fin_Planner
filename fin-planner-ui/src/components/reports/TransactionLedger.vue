...
.badge-info { background: rgba(59, 130, 246, 0.1); color: rgb(37, 99, 235); }
.badge-warning { background: rgba(245, 158, 11, 0.1); color: rgb(217, 119, 6); }
.badge-success { background: rgba(16, 185, 129, 0.1); color: rgb(5, 150, 105); }
